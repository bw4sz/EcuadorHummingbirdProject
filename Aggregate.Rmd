...
```{r,eval=T}
taxsheet<-read_excel("/Users/ben/Dropbox/Lista Planta final/Lista planta final_11042019.xlsx") %>% select(Site,"field_name (AyC)","ID_final") %>% rename(plant_field_name=`field_name (AyC)`,final_plant_name=`ID_final`)
