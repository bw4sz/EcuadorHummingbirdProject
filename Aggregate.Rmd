...
```{r}
transect_data$ID<-paste(transect_data$site,transect_data$site$date,transect_data$waypoint,sep="_")
...
camera_dat$ID<-paste(camera_dat$site,camera_dat$ID,camera_dat$waypoint,sep="_")
...
```{r}
int_data$ID<-paste(int_data$site,int_data$date,int_data$waypoint,sep="_")
